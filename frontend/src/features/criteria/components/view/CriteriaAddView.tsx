...
import { createCriteriaAction } from '@/features/criteria/actions/criteria.action';
...
export default function CriteriaAddView() {
  const [state, action, isPending] = useActionState(createCriteriaAction, null);
              ...
              <div className="flex gap-3">
                <label className="flex-1 cursor-pointer">
                  <input
                    ...
                    className="hidden"
                  />
                  <div className="p-4 border rounded-lg text-center transition peer-checked:border-green-600 peer-checked:bg-green-50 border-green-600 bg-green-50">
                ...
                <label className="flex-1 cursor-pointer">
                  <input
                    ...
                    className="hidden"
                  />
                  <div className="p-4 border rounded-lg text-center transition border-gray-300">
          ...
          <div className="flex justify-end gap-4 pt-6 border-t">
            <div className="w-75 flex items-center gap-4">
              ...
              <Button type="submit" disabled={isPending}>
                {isPending ? 'Menyimpan...' : 'Save Criteria'}
              </Button>
            </div>
          </div>
        </form>
